...
function setup() {
//Creation of the canvas and the positioning of it on the screen
...
//adds a boundary to the right of the graph
  ...
  stroke(0,0,0)
  textSize(20)
//super long if-then statement to write out the equation of the transformed graph
  if(xT > 0) {
    if(yT > 0){
      if(xD == 1){
        if(yD == 1){
...
//slider numbers that appear next to the sliders
  textSize(15)
  text(xT/10, 405, -175);
  text(yT/10, 605, -175);
  // text(xD, 405, -135);
