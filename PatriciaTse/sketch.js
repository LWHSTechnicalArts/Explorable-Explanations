...
var timesplayed;
var timesplayed=0;
var receivedBonushap1 = false;
var receivedBonushea1 = false;
var receivedBonusmon1 = false;
var receivedBonushap2 = false;
var receivedBonushea2 = false;
var receivedBonusmon2 = false;
...
// what happens if player reaches certain level/amount
function Achievements(){
  ...
  contb.hide();
  fill(0, 102, 153);
  if(receivedBonushap1 === true){
    text('+200 happiness',200,200)
  }
  if(receivedBonushap2 === true){
    text('+300 happiness',200,300)
  }
   if(receivedBonushea1 === true){
    text('+200 health',200,400)
  }
  if(receivedBonushea2 === true){
    text('+300 health',200,500)
  }
  if(receivedBonusmon1 === true){
    text('+100 money',200,600)
  }
   if(receivedBonusmon2 === true){
    text('+200 money',200,700)
  }
}
...
// button that goes back to menu screen and has achievements button, continue button, and start button
function menu(){
  console.log("called negative");
  hidebuttons();
  restart.hide();
...
// similar button to start, but doesn't reset values
function cont(){
  console.log("called negative");
  game.hide();
  ac.hide();
...
function monac1(){
  if(valuemon >=100 && receivedBonusmon1 === false){
    fill(0, 102, 153);
    textSize(50);
    text("100+ money", 600, 350);
    hidebuttons();
    setTimeout(back2,500);
    receivedBonusmon1 = true;
  }
}

function hapac1(){
  if(valuehap >=200 && receivedBonushap1 === false){
    textSize(50);
    fill(0, 102, 153);
    text("200+ happiness", 600, 350);
    hidebuttons();
    setTimeout(back2,500);
    receivedBonushap1 = true;
  }
}

function heaac1(){
  if(valuehea >=200 && receivedBonushea1 === false){
    fill(0, 102, 153);
    textSize(50);
    text("200+ health", 600, 350);
    hidebuttons();
    setTimeout(back2,500);
    receivedBonushea1 = true;
  }
}
function monac2(){
  if(valuemon >=200 && receivedBonusmon2 === false){
    fill(0, 102, 153);
    textSize(50);
    text("200+ money", 600, 350);
    hidebuttons();
    setTimeout(back2,500);
    receivedBonusmon2 = true;
  }
}

function hapac2(){
  if(valuehap >=300 && receivedBonushap2 === false){
    textSize(50);
    fill(0, 102, 153);
    text("300+ happiness", 600, 350);
    hidebuttons();
    setTimeout(back2,500);
    receivedBonushap2 = true;
  }
}

function heaac2(){
  if(valuehea >=300 && receivedBonushea2 === false){
    fill(0, 102, 153);
    textSize(50);
    text("300+ health", 600, 350);
    hidebuttons();
    setTimeout(back2,500);
    receivedBonushea2 = true;
  }
}